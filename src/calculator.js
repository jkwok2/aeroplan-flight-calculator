...
export default function calculator(inputString) {
    ...
    const totalPrice = (zone, band, cos) => {
        switch (zone) {
            ...
            case "ATPA":
                if (cos === "e") {
                    return ATPA[band].economy
                } else if (cos == "j") {
                    return ATPA[band].business
                } else if (cos == "f") {
                    return ATAT[band].first
                }
            case "ATSA":
                if (cos === "e") {
                    return ATSA[band].economy
                } else if (cos == "j") {
                    return ATSA[band].business
                } else if (cos == "f") {
                    return ATSA[band].first
                }
            case "NAAT":
                if (cos === "e") {
...
// console.log(testTotalDistance) // DISPLAY
...
// console.log(testTotalPrice) // DISPLAY